    ...
    >
      ...
      >
        ...
        <div
          ...
          "
        >
          <p className="font-semibold max-[770px]:text-[4rem] min-[770px]:text-3xl md:text-[5rem] lg:text-[5rem] xl:text-6xl leading-tight text-white">
            Unlock your new
            <br />
            health intelligence
          </p>

          <p className="mt-6 max-w-xl max-[770px]:text-[1.125rem] min-[770px]:text-base md:text-lg text-white/80">
          ...
          <Image
            ...
            className="mt-8 w-24 md:w-28 opacity-90 invert brightness-0"
