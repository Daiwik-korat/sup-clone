  ...
  return (
    <>
      <header
        ...
        className="bg-[#000000b3] lg:bg-[#504d4d] fixed inset-x-0 z-999 h-15 lg:h-18 flex justify-between w-full max-[991px]:backdrop-blur-md lg:w-[95%] px-5 lg:rounded-full items-center max-w-[85rem] lg:mt-8 lg:pl-6 pb-[0] lg:pr-[0.5rem] lg:mx-auto"
      >
        {" "}
        ...
        <div className="lg:flex hidden items-center justify-center gap-4 text-white">
          {productLoading ? (
